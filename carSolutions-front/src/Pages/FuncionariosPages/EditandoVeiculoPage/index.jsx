...
const EditVeiculo = ({ car, onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="car-form">
      ...
      <input type="number" name="preco" value={carData.preco} onChange={handleChange} placeholder="Preço" required />
      ...
      <input type="text" name="imagem" value={carData.imagem} onChange={handleChange} placeholder="Link da Imagem" required />
